<?php
//include('model/admin/Articles.php');
...
<article>
	<h1>Pages</h1>
	<p><a href="?addPost">Create a New Page</a></p>
	...
	<?php foreach($data as $row){ ?>
		<tr>
		<td scope="row"><a class="articleTitle" href="?articleId=<?php echo $row['article_id']; ?>"><?php echo $row['article_title']; ?></td>
		...
		<td><span class="articleDateTime">
		 ...
		 <td><a href="?editPost=<?php echo $row['article_id']; ?>">Edit</a> | <a href="?deletePost=<?php echo $row['article_id']; ?>" >Delete</a></td>
	  </tr>
		<?php
	}
