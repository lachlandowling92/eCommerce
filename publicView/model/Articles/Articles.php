<?php
include_once ("publicView/model/Articles/Article.php");
?>
<?php
class Articles {
	...
	public function getPageContent($articleId) {
	...
	public function getHomeContent($homeArticleId) {
		include ("includes/connection.php"); //Include pdo
			$sql="SELECT * FROM homeArticles WHERE article_title='$homeArticleId'";
			$s = $pdo -> prepare($sql);
			$s -> execute();
			return $s -> fetch();
	...
	public function getContactContent($data) {
		include ("includes/connection.php"); //Include pdo
			
			$sql="SELECT * FROM CarleyArticle WHERE article_title='$data'";
			$s = $pdo -> prepare($sql);
			$s -> execute();
			return $s -> fetch();
